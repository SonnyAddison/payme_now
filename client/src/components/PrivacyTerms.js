...
const Privacyterms = () => {
    ...
    <div className="container">
     ...
     <p>Follow us on Social Media</p>
      ...
      <div>Last updated: October 12, 2022</div>
      ...
      <div>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.privacypolicies.com/privacy-policy-generator/">Privacy Policy Generator</a>.</div>
      ...
      <li>
      <div><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Payme Now, 123 E Address, Phoenix AZ 85031.</div>
      </li>
      <li>
      ...
      <li>
      <div><strong>Country</strong> refers to: Arizona,  United States</div>
      </li>
      <li>
      ...
      <li>
      <div><strong>Website</strong> refers to Payme Now, accessible from <a href="https://payme-now.herokuapp.com/" rel="external nofollow noopener">https://payme-now.herokuapp.com/</a></div>
      </li>
      <li>
      ...
      <div>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the <a href="https://www.privacypolicies.com/blog/privacy-policy-template/#Use_Of_Cookies_Log_Files_And_Tracking">Privacy Policies website</a> article.</div>
      <div>We use both Session and Persistent Cookies for the purposes set out below:</div>
      <ul>
      <li>
      <div><strong>Necessary / Essential Cookies</strong></div>
      ...
      <li>
      <div><strong>Cookies Policy / Notice Acceptance Cookies</strong></div>
      <div>Type: Google and Facebook Pixel Persistent Cookies</div>
      <div>Administered by: Google and Facebook</div>
      <div>Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</div>
      <div>GDPR Disclosure: We don't agree with or adhere to the GDPR. It is opinion that a country can control records of their citizens across the world and it is that countrys right to try to make laws that affect businesses outside of their own domain. Therefore, if you choose to use our site and live in another area we will not delete the records of your business as if they didn't occur. Our records are our business data.</div>
      </li>
      <li>
